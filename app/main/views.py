...
def summary():
    ...
    return render_template('index.html', loadavg=current_app.curr_device.g_loadavg, \
        stat=current_app.curr_device.g_stat, meminfo=current_app.curr_device.g_meminfo, \
        uptime=current_app.curr_device.g_uptime, cpunum=current_app.curr_device.g_cpunum)
